...
<body style="background-color: var(--duskSky);">
    ...
    <div class="container">
        ...
        if(isset($_POST["registrationSubmit-buttonCheck"])){
            ...
            $usertype=$_POST["role"]; 
            $authtype ='student'; //default authenticatiotype in student table
            ...
            if ($usertype == "student") {
                ...
                if(empty($subjecttaught)){array_push($errors,"Subject taught cannot be empty!");}
                if(empty($datejoinedteacher)){array_push($errors,"Please input the date you have joined!");}

            } elseif ($usertype == "admin") {

                $datejoinedadmin=$_POST["adminDateJoined"];

                if(empty($datejoinedadmin)){array_push($errors,"Please input the date you have joined!");}
            } 
                ...
                if(mysqli_stmt_prepare($stmt,$sqlquery)){
                    ...
                    if($usertype =='student'){
                        ...
                        if(mysqli_stmt_prepare($stmt,$sqlquery)){
                            ...
                            }else {die("Something went wrong in class_student table!");}

                        }else {die("Something went wrong in student table!");}
                        ...
                        else{die("Something went wrong in teacher table!");}
                        mysqli_stmt_close($stmt); //must close stmt
                    }
